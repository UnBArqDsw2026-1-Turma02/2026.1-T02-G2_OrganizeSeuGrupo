...
O grupo decidiu escolher três artefatos principais que representam o projeto. Foi escolhido o Rich Picture, 5W2H e o Diagrama de Ishikawa.

- [Artefatos](./Base/1.2.ArtefatoGeneralista.md)
...
Na etapa Test, validamos o protótipo com potenciais usuários, coletando impressões diretas sobre usabilidade e valor por meio de um questionário. Em seguida, apresentamos o protótipo para estes mesmos usuários, obtendo feedbacks sobre cumprimentos de expectativas e valor de uso para as funcionalidades apresentadas.

O formulário pode ser visualizado pelo [link](https://forms.gle/cgic1AvSV5GmWRrR6). 

Os feedbacks que obtivemos com o formulário foram: 

![q1](../assets/design-sprint/validacao-prototipo/q1.png)
![q2](../assets/design-sprint/validacao-prototipo/q2.png)
![q3](../assets/design-sprint/validacao-prototipo/q3.png)
![q4](../assets/design-sprint/validacao-prototipo/q4.png)
![q5](../assets/design-sprint/validacao-prototipo/q5.png)
![q6](../assets/design-sprint/validacao-prototipo/q6.png)

Logo, podemos inferir que o protótipo foi bem aceito por potenciais usuários do aplicativo e que cumpre com o objetivo do sistema. 
...
| 1.5  | 05/04/2026 | Adição do formulário na etapa de validação | [Mayara Marques](https://github.com/maymarquee) | [Eduardo de Pina](https://github.com/eduardodpms) |
