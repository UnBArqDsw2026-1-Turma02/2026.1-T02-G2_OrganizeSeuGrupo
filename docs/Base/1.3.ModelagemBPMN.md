...
<font size="2">Autor: [Gabriel Fae](https://github.com/faehzin), [Luísa de Souza](https://github.com/luisa12ll) e  [Mayara Marques](https://github.com/maymarquee)</font>
...
<font size="2">Autor: [Eduardo de Pina](https://github.com/eduardodpms), [Gabriel Fae](https://github.com/faehzin) e [Júlio César](https://github.com/julnox) </font>
...
<font size="2">Autor: [Pedro Everton](https://github.com/pedro-everton), [Mayara Marques](https://github.com/maymarquee) e [Lucas Alves ](https://github.com/LucasAlves71)</font>
...
| **Aluno**                           | **Participação**                                                  |
|-------------------------------------|-------------------------------------------------------------------|
| Camila Cavalcante                    | Elaboração do diagrama para **Sprint Review** |
| Eduardo de Pina           | Auxílio e revisão do diagrama para a funcionalidade de **Novo Grupo** |
| Gabriel Sampaio Fae             | Elaboração do diagrama para funcionalidade de **Novo Grupo**, e auxílio no diagrama para **Sprint Review** e no diagrama para **Sprint** |
| Júlio César Costa            | Auxílio no diagrama para a funcionalidade de **Novo Grupo** |
| Lucas Alves Oliveira dos Santos   | Revisão e auxílio no diagrama para a funcionalidade de **Nova Reunião** |
| Luísa de Souza Ferreira              | Elaboração do diagrama para **Sprint** |
| Marcus Vinicius Cunha Dantas     | Elaboração do diagrama para **Sprint Development** |
| Mayara Marques Silva               | Elaboração do diagrama para a funcionalidade de **Nova Reunião**, e revisão do diagrama para **Sprint** |
| Pedro Everton de Paula  | Elaboração do diagrama para a funcionalidade de **Nova Reunião** |
| Thiago Viriato Accioly  | Auxílio e revisão do diagrama para **Sprint Development** |
...
| `1.6`   |06/04/2026 | Detalhamento de contribuições | [Eduardo de Pina](https://github.com/eduardodpms)| [Luisa de Souza](https://github.com/luisa12ll) | 
| `1.7`   |06/04/2026 | Padronização de símbolos visuais | [Eduardo de Pina](https://github.com/eduardodpms)| [Luisa de Souza](https://github.com/luisa12ll) | 
