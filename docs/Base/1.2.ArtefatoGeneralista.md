...
Dessa forma, foi possível:
    ...
    Garantir o envolvimento ativo de todos os membros da equipe;

    Projetar uma solução final por meio da união de diferentes pontos de vista, aproveitando a diversidade de perspectivas.

    Preservar o histórico do processo, mantendo os rascunhos individuais como evidências de trabalho, lado a lado com o resultado mais solido.
